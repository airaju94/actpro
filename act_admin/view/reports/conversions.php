...
<div class="card mb-4">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">Conversions Chart</h5>
    </div>
    <div class="card-body">
...
<div class="col-12 mb-4">
    <div class="card">
        <div class="card-header bg-primary text-white d-flex justify-content-between">
            <div>
                <h5 class="mb-0 mt-1">Conversions Report</h5>
            </div>
            <div>
                <button class="btn btn-sm btn-light py-0 rounded-1" onclick="exportTableCSV('#conversionsTable')"><i class="bi bi-filetype-csv me-1"></i> Export</button>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <div id="conversionsTable"></div>
            </div>
        </div>
    </div>
</div>
<script>
    const reportType = 'conversions';
    var dimension = 'date';
