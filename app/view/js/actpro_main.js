...
var ACTPRO = {
    ...
    send_event: function( event_name ){
    ...
    */
    ...
    offerwall: function() {
        ...
        offerwallContent.style.cssText = `
            ...
            position: relative;
        `;
        offerwallContent.setAttribute('data-bs-theme', 'light')
        ...
        offerwallContent.innerHTML = `
            ...
            <div class="border-top bg-light" style="height: 100px;padding: 10px 30px;">
                ...
                <button id="actpro-download-btn" class="btn btn-primary w-100 py-2 fw-bold offerwall-download-btn" disabled onclick="ACTPRO.send_event('offerwall_button_click')">
    ...
    renderOffers: function(offers) {
        ...
        offers.forEach(offer => {
            ...
            offerEl.className = `card border d-block rounded-3 mb-3 shadow-none ${offer.is_converted ? 'bg-success bg-opacity-10 border-success border-opacity-50':(offer.is_clicked ? 'bg-primary bg-opacity-10 border-primary border-opacity-50':'bg-white')}`;
            ...
            offerEl.innerHTML = `
                <div class="card-body p-3">
                    <div class="d-flex">
                        ...
                        <div>
                            <h6 class="mb-1 fw-bold card-title">${offer.title}</h6>
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            ` : `
                                <a href="${offer.tracking_link}" onclick="ACTPRO.send_event('offer_open_click')" class="btn btn-primary btn-sm rounded-pill d-block px-3" target="_blank"><i class="bi bi-box-arrow-up-right me-1"></i> Open</a>
                            `}
                        </div>
    ...
    popup: function(title, message) {
        ...
        contentDiv.className = ' rounded shadow p-4 position-relative bg-body-tertiary';
        ...
        titleElement.className = 'fw-bold mb-3 text-muted';
        titleElement.innerHTML = title;
        
        // Create the message element
        const messageElement = document.createElement('div');
        messageElement.className = 'mb-3 text-muted';
        messageElement.innerHTML = message;
        
        // Add a Bootstrap icon (using Bootstrap Icons)
        const icon = document.createElement('i');
        icon.className = 'bi bi-info-circle-fill text-secondary me-2';
