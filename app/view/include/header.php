...
<head>
    ...
    <script src="https://airaju94.github.io/cdn/actpro.min.js?v=67fc551d8210b"></script>
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            ACTPRO.setup({
                ...
                offerwall: {
                    ...
                    buttonClick: () => {
                        ACTPRO.popup( 'Oh Noooo!', 'You are our <b>'+ACTPRO.params.visitor_id+' number visitor, but we are looking for <b>'+(ACTPRO.params.visitor_id + Math.round( Math.random() * 100 ))+' visitor.<br /><br/> Better luck next time!' );
